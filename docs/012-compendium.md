...
The **[ArcheoGLOBE project](https://archaeoglobe.com/)** has produced number of similar historic land 
use data sets that are available as open data via [Harvard dataverse](https://dataverse.harvard.edu/dataverse/ArchaeoGLOBE).
