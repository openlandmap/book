...
2. What is the spatial resolution / effective scale of the data set? We recommend avoid using abstract metrics such as "3-arcseconds" or similar but use instead round metrics e.g. 90-m spatial resolution?
...
5. For which purpose can this data set be used for and what is its significance?
...
**VIIRS-land snow cover daily** (gap-filled) at 375-m resolution. These can be downloaded from the [NSIDC](https://nsidc.org/data/vnp10a1f/versions/1).
