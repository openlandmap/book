...
1. What is the DOI of the data set i.e. what is the permanent URL from which it can be downloaded?
2. What is the spatial resolution / effective scale of the data set (use round metrics e.g. 100-m)?
3. Which referent time-period does the data set covers / what is the time-span of the training or input data?
4. What is the #1 technical documentation for this data set i.e. peer-review publication DOI or similar?
5. What can this data set be used for i.e. what is its significance?
...
-  https://r-spatial.org/ and https://rspatial.org/ packages and tutorials for accessing geospatial data using R;
...
@tang2023global made a global inventory (polygon map) of mining areas (mine area coverage): 
