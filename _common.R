...
status <- function(type) {
  ...
  cat(paste0(
    "::: {.rmdnote}\n",
    "You are reading the work-in-progress OpenLandMap.org Open Land Data Services. ",
    "This chapter is currently ", status, ". ",
    "You can find the polished first edition at <https://openlandmap.github.io/book/>.\n",
    ":::\n"
  ))
}
