...
categories up to pre-historic times 10,000 BCE to CE 2020 [@klein2017anthropogenic]. A similar data set to 
HYDE is HILDA+ [@winkler2021global], which is probably the longest time-series of land cover (9 classes only) data spanning from 
1962 to 2022 and at relatively fine resolution of 1~km; data is available for download from [Pangea](https://doi.pangaea.de/10.1594/PANGAEA.921846).
